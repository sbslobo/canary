...
GameStore.Categories = {
	-- Premium Time
    {
        ...
        rookgaard = true,
        state = GameStore.States.STATE_NONE,
        subclasses = { "Premium Time", "Utilities" },
    },
    -- VIP Shop ~ Premium Time
    {
        icons = { "Category_PremiumTime.png" },
        name = "Premium Time",
        parent = "VIP Shop",
        ...
        offers = {
            {
                ...
                id = 3030,
                validUntil = 30,
                description = "<i>Enjoy 30 days of premium benefits!</i>" ..  premiumDescription .. "",
            ...
            },
            {
                ...
                id = 3090,
                validUntil = 90,
                description = "<i>Enjoy 90 days of premium benefits!</i>" ..  premiumDescription .. "",
                type = GameStore.OfferTypes.OFFER_TYPE_PREMIUM,
            },
            {
                ...
                id = 3180,
                validUntil = 180,
                description = "<i>Enjoy 180 days of premium benefits!</i>" ..  premiumDescription .. "",
                type = GameStore.OfferTypes.OFFER_TYPE_PREMIUM,
            },
        },
    },
	{
		...
		offers = {
			...
			{
				icons = { "Outfit_Jersey_Male_Addon_3.png", "Outfit_Jersey_Female_Addon_3.png" },
				name = "Full Jersey Outfit",
				price = 1500,
				sexId = { female = 620, male = 619 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Jersey outfit represents casual style with a touch of athletic charm, great for casual adventuring or social events.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Recruiter_Male_Addon_3.png", "Outfit_Recruiter_Female_Addon_3.png" },
				name = "Full Recruiter Outfit",
				price = 1500,
				sexId = { female = 745, male = 746 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Recruiter outfit is ideal for leaders and mentors guiding others through the challenges of Tibian life.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Retro Warrior outfit brings back the nostalgic era of classic Tibian adventurers, equipped for battle and survival.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Retro Summoner outfit celebrates the roots of Tibian magic with classic robes and mystical accessories.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Retro_Noblewoman_Male_Addon_3.png", "Outfit_Retro_Noblewoman_Female_Addon_3.png" },
				name = "Full Retro Noblewoman Outfit",
				price = 1500,
				sexId = { female = 967, male = 966 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Retro Noblewoman outfit exemplifies classic aristocratic style, perfect for Tibian royals and adventurers alike.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Retro_Mage_Male_Addon_3.png", "Outfit_Retro_Mage_Female_Addon_3.png" },
				name = "Full Retro Mage Outfit",
				price = 1500,
				sexId = { female = 969, male = 968 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Retro Mage outfit embodies the essence of magical prowess from the golden age of Tibia.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Retro_Knight_Male_Addon_3.png", "Outfit_Retro_Knight_Female_Addon_3.png" },
				name = "Full Retro Knight Outfit",
				price = 1500,
				sexId = { female = 971, male = 970 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Retro Knight outfit recalls the glory of early Tibian defenders, armored and ready for any challenge.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Retro_Hunter_Male_Addon_3.png", "Outfit_Retro_Hunter_Female_Addon_3.png" },
				name = "Full Retro Hunter Outfit",
				price = 1500,
				sexId = { female = 973, male = 972 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Retro Hunter outfit highlights the skill and precision of classic Tibian hunters.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				icons = { "Outfit_Retro_Citizen_Male_Addon_3.png", "Outfit_Retro_Citizen_Female_Addon_3.png" },
				name = "Full Retro Citizen Outfit",
				price = 1500,
				sexId = { female = 975, male = 974 },
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Retro Citizen outfit represents Tibian simplicity, a nostalgic throwback to the humble beginnings of the game.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Lion of War outfit showcases ferocity and leadership, perfect for adventurers commanding the battlefield.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Dragon Slayer outfit represents the epitome of courage and bravery, designed for adventurers who conquer the fiercest beasts.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Royal Costume outfit is tailored for Tibian nobility and players who value elegance and regality.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Formal Dress outfit is perfect for grand Tibian occasions, combining sophistication and charm.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Darklight Evoker outfit symbolizes mystery and dark magic, ideal for adventurers who embrace the shadows.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Doom Knight outfit projects fear and dominance, designed for fearless warriors of Tibia.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Celestial Avenger outfit symbolizes divine justice, perfect for those who fight for a righteous cause.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Blade Dancer outfit highlights agility and precision, ideal for adventurers who masterfully wield dual blades.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n\n<i>The Beekeeper outfit brings harmony with nature, perfect for adventurers who love Tibia's flora and fauna.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},		
		},
	},
		...
		offers = {
			{
				...
				price = 1000,
				id = 194,
				description = "{character}\n{speedboost}\n\n<i>All aboard the Gloothomotive! This mechanical marvel of a mount is sure to turn heads as you roll through any terrain with style.</i>",
			...
			},
			{
				...
				price = 1000,
				id = 231,
				description = "{character}\n{speedboost}\n\n<i>Bright and buzzing with energy, the Bumblebee mount is the perfect companion for adventurous spirits.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1000,
				id = 230,
				description = "{character}\n{speedboost}\n\n<i>The Crimson Fang prowls through the shadows, a fierce and loyal companion for the brave-hearted.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1000,
				id = 229,
				description = "{character}\n{speedboost}\n\n<i>Emerging from the depths of the swamp, the Bog Tyrant commands respect and awe wherever it goes.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1000,
				id = 228,
				description = "{character}\n{speedboost}\n\n<i>With frostbitten scales and a chilling aura, the Glacier Wyrm is a force of icy power.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1250,
				id = 226,
				description = "{character}\n{speedboost}\n\n<i>Soaring through the heavens, the Skybreaker Pegasus is a majestic mount of unparalleled grace.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1250,
				id = 225,
				description = "{character}\n{speedboost}\n\n<i>Flames of wrath and determination surround the Wrathfire Pegasus as it blazes across the skies.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1250,
				id = 224,
				description = "{character}\n{speedboost}\n\n<i>A bringer of hope and light, the Dawnbringer Pegasus inspires all who behold it.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1400,
				id = 223,
				description = "{character}\n{speedboost}\n\n<i>Beware the many heads of the Gorgon Hydra, a creature of myth and legend now tamed for your journey.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1400,
				id = 221,
				description = "{character}\n{speedboost}\n\n<i>The eerie glow of the Corpsefire Skull will light your path through the darkest nights.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1400,
				id = 220,
				description = "{character}\n{speedboost}\n\n<i>Fiery and unstoppable, the Magma Skull burns with an intense heat, ready to conquer any challenge.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1400,
				id = 219,
				description = "{character}\n{speedboost}\n\n<i>Harbinger of doom and destruction, the Doom Skull strikes fear into all who dare to oppose its rider.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1250,
				id = 215,
				description = "{character}\n{speedboost}\n\n<i>Stubborn and steadfast, the Obstinate Ox stands its ground and pushes through any obstacle.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1250,
				id = 214,
				description = "{character}\n{speedboost}\n\n<i>The Surly Steer charges ahead with an indomitable spirit, a mount for the determined.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 1250,
				id = 213,
				description = "{character}\n{speedboost}\n\n<i>With an unrelenting energy, the Boisterous Bull leads its rider to victory and triumph.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
		}
	},
        ...
        offers = {
			{
				...
				itemtype = 28561,
				count = 1,
				description = "<i>Train your skills 25% more effectively at home than in public on this expert exercise dummy!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} can only be used by one character at a time\n{useicon} use one of the exercise weapons on this dummy\n{backtoinbox}",
    ...
    -- VIP Shop ~ Utilities
    {
        ...
        offers = {
            {
                icons = { "Teleportation_Bell.png" },
                name = "Supreme Cube",
                price = 1500,
                itemtype = 31633,
                count = 1,
                description = "<i>Use it to teleport yourself to useful places with a 3-minute cooldown.</i>",
                type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
            },
			{
				icons = { "Teleportation_Bell.png" },
				name = "Codex of Redemption",
				price = 1500,
				itemtype = 49698,
				count = 1,
				description = "<i>Harness the sacred power of redemption. Use this tome to grant yourself all blessings. \n\n It lasts for ever.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},	
			{
				...
				itemtype = 23721,
				count = 1,
				description = "<i>A helpful bag that allows you to carry all you can loot from your hunt as long you have enought capacity.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},	
            {
                icons = { "Teleportation_Bell.png" },
                name = "Roulette Ticket",
                price = 1500,
                itemtype = 49699,
                count = 1,
                description = "<i>A mysterious ticket infused with the magic of fortune. Use it to spin the roulette and unlock incredible treasures!</i>",
                type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
            },	
            {
                icons = { "Teleportation_Bell.png" },
	...
	-- Boost
	{
		...
		offers = {
			...
			},
			{
				icons = { "XP_Boost.png" },
				name = "XP Boost 100%",
				price = 200, -- Precio más alto para el boost del 100%
				id = 65011, -- ID único para esta oferta
				description = "<i>Purchase a boost that increases the experience points your character gains from hunting by 100%!</i>\n\n{character}\n{info} lasts for 1 hour hunting time\n{info} paused if stamina falls under 14 hours\n{info} can be purchased up to 5 times between 2 server saves\n{info} cannot be purchased if an XP boost is already active",
				type = GameStore.OfferTypes.OFFER_TYPE_EXPBOOST,
				boostPercent = 100
			},
		},
	...
	},
	{
		...
		offers = {
			{
				icons = { "Dust_Forge.gif" },
				name = "Dust",
				price = 15,
				id = GameStore.SubActions.DUST_FORGE,
				count = 5,
				description = "<i>Useful for the Exaltation Forge.</i>",
				type = GameStore.OfferTypes.DUST_FORGE,
			},
			{
				icons = { "Dust_Forge.gif" },
				name = "Dust",
